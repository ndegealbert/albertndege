...
const OpenSource = () => (
  <SectionContainer inverted>
    {/* <StyledHeader>
      ...
      <StyledParagraph>
        I contribute to open source projects such as React, Mattermost, Mozilla
        Firefox and others because I care about the future of the communities
        that I take part in.
      </StyledParagraph>
    </StyledHeader>
    ...
    <StyledParagraph>
      <StyledButton
        size="large"
        href="https://github.com/ndegealbert"
        target="_blank"
    ...
    <StyledParagraph>
      <StyledButton
        size="large"
        href="https://drive.google.com/file/d/1SffK8wB39U5BfxkcO_uIZZ7CQHmu9J7k/view?usp=sharing"
        target="_blank"
        rel="noopener noreferrer"
      >
        Download my Resumes
